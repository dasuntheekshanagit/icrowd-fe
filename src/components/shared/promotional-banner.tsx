                    ...
                    <div className="relative h-64 w-full">
                        ...
                        <div
                            ...
                            <DialogHeader className="text-left mb-2">
                                <DialogTitle className="text-2xl font-bold text-white">{bannerData.title || "New Year Sale!"}</DialogTitle>
                            </DialogHeader>
                            <p className="mb-4 text-white/90">{bannerData.description || "Get up to 50% off on selected items. Limited time offer."}</p>

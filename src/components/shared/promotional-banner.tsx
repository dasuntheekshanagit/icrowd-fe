        ...
        <div className="relative bg-background rounded-lg overflow-hidden shadow-xl">
          ...
          <div className="relative h-64 w-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-6 text-white">
              ...
              <p className="mb-4 text-white/90">Get up to 50% off on selected items. Limited time offer.</p>
              <Button className="w-full bg-white text-black hover:bg-white/90" onClick={() => setIsOpen(false)}>
                Shop Now
              </Button>
            </div>
          </div>

                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="max-w-xl text-center md:text-left">
                        ...
                        <motion.p
                            ...
                            className="text-lg text-primary-foreground/70 mt-4"
                        >
                    ...
                    >
                        <Button
                            asChild
                            size="lg"
                            className="rounded-full bg-accent text-accent-foreground h-14 px-8 text-lg shadow-accent-glow hover:bg-accent/90"
                        >
                            <Link to="/products">
                                Shop All Products
                        ...
                        <Button
                            asChild
                            size="lg"
                            className="rounded-full h-14 px-8 text-lg border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10"
                        >
